...
<head>
    ...
    <meta name="description" content="FEEDBACK - MSM KKD NORTH">
    ...
    <!-- Title-->
    <title>FEEDBACK - MSM KKD NORTH</title>
    <!-- Fonts-->
...
<center>
<!-- <iframe src="https://docs.google.com/forms/d/e/1FAIpQLSe96QoXaI70ivfwt7UJkzCMyg_Bct60H3A7r3mlrCHcQ4UraA/viewform?embedded=true" width="640" height="833" frameborder="0" marginheight="0" marginwidth="0">Loading…</iframe> -->
<!-- <iframe src="https://docs.google.com/forms/d/e/1FAIpQLSeYmDnCccWeMlMS9-B0-w_gmzjbZNKyGJJpZPy6myOhPgzLqg/viewform?embedded=true"  width="370" height="480" frameborder="0" marginheight="0" marginwidth="0">Loading…</iframe> -->

          <!-- <iframe class="responsive-iframe" src="https://docs.google.com/forms/d/e/1FAIpQLSc0gcU7D3uGvL74Sjrb9odx5MUPQ6HAThCTmVw7rnD5CoV5ug/viewform" >Loading…</iframe> -->
         ...
         <!-- <iframe  class="w-100 rounded-lg"  width="370" height="390" src="https://www.youtube.com/embed/hX9Ze8wVpI4" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe> --> 
          ...
          <iframe src="https://docs.google.com/forms/d/e/1FAIpQLSeP5gHBttJS6qPFckX4Po30T3RbJY1SoUqCdMQHZhNhVAzDBA/viewform?embedded=true" class="w-100 rounded-lg"  width="370" height="490" frameborder="0" marginheight="0" marginwidth="0">Loading…</iframe>
    ...
    <!-- Apex Chart-->
    <script src="assets3/js/apexcharts.min.js"></script>
    <script src="assets3/js/default/chart-active.js"></script>
    <!-- PWA-->
