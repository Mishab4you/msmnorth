...
<body>
  ...
  <div class="coming-soon-wrapper bg-white text-center bg-overlay"
    style="background-image: url('assets3/img/bg-img/26.jpg')">
    <div class="container">
      <!-- <div class="cs-logo"><a href="index.php"><img src="assets3/img/bg-img/msmlogo.png" width="160px" height="160px"></a></div> --> 
      <!-- <h2 class="text-white display-3">Coming Soon</h2>
      <p class="text-white">The quiz will starts at sharp <font color="red">1.30 pm</font> today inshallah.</p> -->

      <h2 class="text-white display-3">Coming Soon...</h2>
      <p class="text-white">This page will open after today's session. Or if this page is not opening, please refresh this page.</p>

      <div class="notify-email mt-5">
        <a href="index.php" class="btn btn-warning" type="button">Back to home</a>
      </div>
    </div>
  </div>
