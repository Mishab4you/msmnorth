...
<!-- Mirrored from designing-world.com/affan-1.1.0/page-about-us.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 02 May 2021 12:40:18 GMT -->
<head>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="description" content="MSM KKD NORTH">
    ...
    <!-- Title-->
    <title>Quiz Results - MSM KKD NORTH</title>
    <!-- Fonts-->
      ...
      <div class="container">
        ...
        <div class="card image-gallery-card direction-rtl">
          <div class="page-content-wrapper py-3">
            ...
            <div class="container">
                  <center>   <h5>Quiz Results<strong> Day - 5</strong></h5></center> <br>
              <div class="card service-card bg-primary bg-gradient mb-3">
                <div class="card-body">
                  <div class="d-flex align-items-center">
                    <div class="service-text">
                      <h5><span class="p1">1st</span><br><strong>Hamna Meppayur</strong></h5>
                      <p class="mb-0">Meppayur</p>
                    </div>
                    <!-- <div class="service-img"><img src="img/bg-img/sec.png" alt=""></div> -->
                  </div><br>
                  <img class="mb-3 rounded" src="assets3/img/bg-img/6certifcte 1.jpg" alt="">

                </div>
              </div>
              <!-- Service Card-->
              <div class="card service-card bg-secondary bg-gradient mb-3">
                <div class="card-body">
                  <div class="d-flex align-items-center">
                    <div class="service-text">
                      <h5><span class="p1">2nd</span><br><strong>Jafna K.P</strong></h5>
                      <p class="mb-0">Kakkattil</p>
                    </div>
                    <!-- <div class="service-img"><img src="img/bg-img/sec.png" alt=""></div> -->
                  </div><br>
                  <img class="mb-3 rounded" src="assets3/img/bg-img/6certifcte 2.jpg" alt="">
              ...
              <div class="card service-card bg-dark bg-gradient mb-3">
                <div class="card-body">
                  <div class="d-flex align-items-center">
                    <div class="service-text">
                      <h5><span class="p1">3rd</span><br><strong>Shasla Villipally</strong></h5>
                      <p class="mb-0">Villipally</p>
                    </div>
                    <!-- <div class="service-img"><img src="img/bg-img/sec.png" alt=""></div> -->
                  </div><br>
                  <img class="mb-3 rounded" src="assets3/img/bg-img/6certifcte 3.jpg" alt="">

                </div>
              </div><br>
              <center><h3 class="p1">Congratulations to the winners!</h3><br>
                <a class="btn btn-creative btn-primary" href="index.php">Back to main page</a><br>
                <!-- <button class="btn btn-creative btn-danger" type="button" data-bs-toggle="modal" data-bs-target="#day2">Quiz Results Day - 2</button> -->
...
<!-----models----->
    <div class="modal fade" id="day2" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
          <div class="modal-header">
            <h6 class="modal-title" id="staticBackdropLabel">Quiz Results</h6>
      ...
      <div class="container">
        ...
        <div class="card image-gallery-card direction-rtl">
          <div class="page-content-wrapper py-3">
            ...
            <div class="container">
                  <center>   <h5>Quiz Results<strong> Day - 4</strong></h5></center> <br>
              <div class="card service-card bg-primary bg-gradient mb-3">
                <div class="card-body">
                  <div class="d-flex align-items-center">
                    <div class="service-text">
                      <h5><span class="p1">1st</span><br><strong>Jafna Kakkattil</strong></h5>
                      <p class="mb-0">Kakkattil</p>
                    </div>
                    <!-- <div class="service-img"><img src="img/bg-img/sec.png" alt=""></div> -->
                  </div><br>
                  <img class="mb-3 rounded" src="assets3/img/bg-img/4certifcte 1.jpg" alt="">
              ...
              <div class="card service-card bg-secondary bg-gradient mb-3">
                <div class="card-body">
                  <div class="d-flex align-items-center">
                    <div class="service-text">
                      <h5><span class="p1">2nd</span><br><strong>Hamna Meppayur</strong></h5>
                      <p class="mb-0">Meppayur</p>
                    </div>
                    <!-- <div class="service-img"><img src="img/bg-img/sec.png" alt=""></div> -->
                  </div><br>
                  <img class="mb-3 rounded" src="assets3/img/bg-img/4certifcte 2.jpg" alt="">
              ...
              <div class="card service-card bg-dark bg-gradient mb-3">
                <div class="card-body">
                  <div class="d-flex align-items-center">
                    <div class="service-text">
                      <h5><span class="p1">3rd</span><br><strong>Ishaq V.P Thuvakkunnu</strong></h5>
                      <p class="mb-0">Thuvakkunnu</p>
                    </div>
                    <!-- <div class="service-img"><img src="img/bg-img/sec.png" alt=""></div> -->
                  </div><br>
                  <img class="mb-3 rounded" src="assets3/img/bg-img/4certifcte 3.jpg" alt="">

                </div>
              </div><br>
              <center><h3 class="p1">Congratulations to the winners!</h3><br>
                <a class="btn btn-creative btn-primary" href="index.php">Back to main page</a>
              </center>
